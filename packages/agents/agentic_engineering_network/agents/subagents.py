...
SUBAGENT_REGISTRY: tuple[SubagentDefinition, ...] = (
    ...
    _subagent(
        ...
        ("contract_reader", "requirements_parser", "requirements_contract"),
        ("functional_contract",),
    ...
    _subagent(
        ...
        ("contract_reader", "risk_matrix", "requirements_contract"),
        ("quality_attributes",),
    ...
    _subagent(
        ...
        ("contract_reader", "test_plan_reader", "test_quality"),
        ("edge_case_matrix",),
    ...
    _subagent(
        ...
        ("architecture_reader", "task_graph", "dependency_doctor"),
        ("dependency_graph",),
    ...
    _subagent(
        ...
        ("requirements_reader", "architecture_modeler", "architecture_fitness"),
        ("domain_map",),
    ...
    _subagent(
        ...
        ("contract_reader", "api_contract", "repository_intelligence"),
        ("api_contract_review",),
    ...
    _subagent(
        ...
        ("architecture_modeler", "deployment_reader", "infrastructure_validation"),
        ("runtime_topology",),
    ...
    _subagent(
        ...
        ("component_inspector", "test_report_reader", "browser_e2e", "ux_quality"),
        ("visual_qa_plan",),
    ...
    _subagent(
        ...
        ("api_contract_reader", "repository_context", "data_pipeline", "ml_evaluation"),
        ("service_design",),
    ...
    _subagent(
        ...
        ("contract_reader", "failure_diagnostics", "api_contract", "external_integration_verification"),
        ("integration_plan",),
    ...
    _subagent(
        ...
        ("schema_inspector", "database_migration", "backup_restore"),
        ("migration_plan",),
    ...
    _subagent(
        ...
        ("query_inspector", "security_policy_reader", "performance_testing"),
        ("query_review",),
    ...
    _subagent(
        ...
        ("workflow_reader", "security_audit", "release_packaging", "git_collaboration", "supply_chain_compliance"),
        ("cicd_plan",),
    ...
    _subagent(
        ...
        ("deployment_reader", "evidence_reader", "runtime_observability", "backup_restore", "deployment_verification"),
        ("operations_plan",),
    ...
    _subagent(
        ...
        ("failure_diagnostics", "api_contract", "sandbox_verification", "performance_testing"),
    ...
    _subagent(
        ...
        ("contract_reader", "test_report_reader", "test_quality", "requirements_contract"),
    ...
    _subagent(
        ...
        ("dependency_manifest_reader", "security_audit", "supply_chain_compliance"),
        ("supply_chain_review",),
    ...
    _subagent(
        ...
        ("patch_workspace", "repository_intelligence", "architecture_fitness"),
        ("entropy_findings",),
    ...
    _subagent(
        ...
        ("artifact_reader", "release_packaging", "release_provenance"),
        ("package_evidence",),
    ...
    _subagent(
        ...
        ("database_migration", "release_packaging"),
    ...
    _subagent(
        ...
        ("evidence_reader", "gate_reader", "release_provenance", "deployment_verification"),
        ("release_evidence",),
