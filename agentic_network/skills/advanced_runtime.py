...
from agentic_network.skills.frontier_runtime import (
    FRONTIER_SKILLS,
    execute_frontier_action,
)
from agentic_network.skills.precision_runtime import (
    PRECISION_SKILLS,
    execute_precision_action,
)
...
def execute_advanced_action(
    ...
    elif skill_name in FRONTIER_SKILLS:
        result = execute_frontier_action(skill_name, action, payload, workspace, project_root)
    elif skill_name in PRECISION_SKILLS:
        result = execute_precision_action(skill_name, action, payload, workspace, project_root)
