...
SUBAGENT_REGISTRY: tuple[SubagentDefinition, ...] = (
    ...
    _subagent(
        ...
        ("component_inspector", "test_report_reader", "browser_e2e"),
        ("visual_qa_plan",),
    ...
    _subagent(
        ...
        ("contract_reader", "failure_diagnostics", "api_contract"),
        ("integration_plan",),
    ...
    _subagent(
        ...
        ("schema_inspector", "database_migration"),
        ("migration_plan",),
    ...
    _subagent(
        ...
        ("deployment_reader", "container_operations", "sandbox_verification"),
        ("container_plan",),
    ...
    _subagent(
        ...
        ("workflow_reader", "security_audit", "release_packaging"),
        ("cicd_plan",),
    ...
    _subagent(
        ...
        ("failure_diagnostics", "api_contract", "sandbox_verification"),
    ...
    _subagent(
        ...
        ("dependency_manifest_reader", "security_audit"),
        ("supply_chain_review",),
    ...
    _subagent(
        ...
        ("patch_workspace", "repository_intelligence"),
        ("entropy_findings",),
    ...
    _subagent(
        ...
        ("artifact_reader", "release_packaging"),
        ("package_evidence",),
